...
class VAE:
    def __init__(self, sd=None, device=None, config=None, dtype=None, metadata=None, **kwargs):
        ...
        self.max_memory_vram_use = kwargs.get("max_memory_vram_use", 0)
        ...
        if self.max_memory_vram_use != 0:
            model_management.load_models_gpu(
                [self.patcher],
                memory_target_load=self.max_memory_vram_use,
